...
<head>
    ...
    {if isset($globalCSS)}
        <link rel="stylesheet" href="{$globalCSS|escape:'html'}" />
    {/if}
</head>
...
<div class="content">
    ...
    <p><img src="{$this_path|escape:'html'}/views/img/cv_card.gif" width="259" height="181" alt="{l s='CVV' mod='cardinity'}"></p>
    ...
    <p><img src="{$this_path|escape:'html'}/views/img/cv_amex_card.gif" alt="{l s='CVV on AMEX' mod='cardinity'}" width="259" height="181">
    </p>
</div>
